...
public interface PlantService {
     ...
     * 根据用户ID获取植物列表（分页）
     */
    PageResponse<PlantResponse> getPlantsByUserId(PageQueryRequest request);

    /**
     * 根据ID获取植物详情（需要验证用户权限）
     */
    PlantResponse getPlantById(Long id, Long userId);
     ...
     * 更新植物信息（需要验证用户权限）
     */
    PlantResponse updatePlant(Long id, PlantRequest request);
